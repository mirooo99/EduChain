...
function Header() {
  return (
    <header style={{ textAlign: 'center', padding: '20px 0', borderBottom: '2px solid #ddd' }}>
      ...
      <p>Адрес за справка: 
    <a href="https://etherscan.io/address/0x7F7D5821234e313F4d7dcf1d4fDf4b550AdC9554" target="_blank" rel="noopener noreferrer" style="font-family: monospace; word-break: break-all;">
